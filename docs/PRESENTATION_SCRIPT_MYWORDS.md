...
> **Note:** This script is optimized for a fast, punchy 4-minute presentation (~450 spoken words at 125–130 wpm). It removes conversational filler while keeping all physics claims, benchmark metrics, economic VOI results, and roadmap targets intact.
